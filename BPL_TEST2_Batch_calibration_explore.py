...
def newplot(title="Batch cultivation", plotType="TimeSeries"):
    ...
    if plotType == "TimeSeries":
        ...
        diagrams.clear()
        diagrams.append(
            "ax11.plot(t,sim_res['bioreactor.c[2]'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax21.plot(t,sim_res['bioreactor.c[1]'],color='b',linestyle=linetype)"
        )
        diagrams.append("ax12.set_title('- microscopic world')")
        diagrams.append(
            "ax12.plot(t,-sim_res['bioreactor.culture.q[2]'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax22.plot(t,sim_res['bioreactor.culture.q[1]'],color='b',linestyle=linetype)"
        )
        ...
        diagrams.append(
            "ax[1].plot(t,sim_res['bioreactor.c[1]'],color='r',linestyle=linetype)"
        )
        ...
        diagrams.clear()
        diagrams.append(
            "ax[0].plot(sim_res['bioreactor.c[1]'],sim_res['bioreactor.c[2]'],color='b',linestyle=linetype)"
        )
